...
<div class="wrapper">
    ...
    <section>
        ...
        <div class="content-wrapper">
            <h3><c:out value="${historySingleTask.name }"></c:out>&nbsp;&nbsp;&nbsp;&nbsp;
                启动时间：<c:out value="${historySingleTask.starttime }"/>&nbsp;&nbsp;&nbsp;&nbsp;结束时间：<c:out
                        value="${historySingleTask.endtime }"/></h3>
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div style="font-size: 30px"><c:out
                                            value="${historySingleTask.lastCrawlTime }"/></div>
                                    <p class="m0">抓取时间</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="text-lg"><c:out
                                            value="${historySingleTask.lastTotalCrawlCount }"/></div>
                                    <p class="m0">总抓取量</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-warning">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="text-lg"><c:out value="${historySingleTask.depth }"/></div>
                                    <p class="m0">结束层数</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="text-lg"><c:out value="${historySingleTask.passed }"/></div>
                                    <p class="m0">遍数</p>
                                </div>
                            </div>
                        </div>
